  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6 pr-48">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Ed25519 KeyPair Manager</h1>
        {keyPair && (
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">{!keyPair ? (
        <div className="text-center py-8">
          <div className="flex justify-center mb-4">
            <Key className="text-gray-600 dark:text-gray-400" size={64} />
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
            ...
            <div className="flex gap-2">
              <input
                ...
                readOnly
                className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white font-mono text-sm"
              />
              <button
                onClick={() => {
